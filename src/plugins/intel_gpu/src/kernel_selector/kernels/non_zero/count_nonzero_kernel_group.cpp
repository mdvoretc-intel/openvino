...
#include "count_nonzero_kernel_group.h"
#include "kernel_selector_utils.h"
#include <string>

namespace kernel_selector {
ParamsKey CountNonzeroKernelGroup::GetSupportedKey() const {
    ParamsKey k;
...
CountNonzeroKernelGroup::DispatchData CountNonzeroKernelGroup::SetDefault(const count_nonzero_params& params) const {
...
DeviceFeaturesKey CountNonzeroKernelGroup::get_required_device_features_key(const Params& params) const {
    DeviceFeaturesKey k;
...
void CountNonzeroKernelGroup::GetUpdateDispatchDataFunc(KernelData& kd) const {
...
KernelsData CountNonzeroKernelGroup::GetKernelsData(const Params& params) const {
...
KernelsPriority CountNonzeroKernelGroup::GetKernelsPriority(const Params& /*params*/) const {
    return DONT_USE_IF_HAVE_SOMETHING_ELSE;
}

bool CountNonzeroKernelGroup::Validate(const Params& p) const {
